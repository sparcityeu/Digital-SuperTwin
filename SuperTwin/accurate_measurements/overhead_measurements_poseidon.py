...
if __name__ == "__main__":
    ...
    main("10.92.55.4", " -c poseidon_10.conf :configured", "poseidon", "try0", "poseidon10")
    print("With 20 metrics")
    main("10.92.55.4", " -c poseidon_20.conf :configured", "poseidon", "try0", "poseidon20")
    print("With 30 metrics")
    main("10.92.55.4", " -c poseidon_30.conf :configured", "poseidon", "try0", "poseidon30")
    print("With 40 metrics")
    main("10.92.55.4", " -c poseidon_40.conf :configured", "poseidon", "try0", "poseidon40")
    print("With 50 metrics")
    main("10.92.55.4", " -c poseidon_50.conf :configured", "poseidon", "try0", "poseidon50")
    print("With monitor metrics")
    main("10.92.55.4", " -c pcp_poseidon_monitor :configured", "poseidon", "try0", "poseidonmonitor")
    print("#########################################################################################")
