...
def main():
    ...
    buttons2 = []
    print("vis_threads.keys():", vis_threads.keys())
    ...
    cpu_name = "Intel(R) Xeon(R) Gold 6152 CPU @ 2.10GHz"
    l1dcache_size = "32 kB"
    l2cache_size = "1 MB"
    l3cache_size = "30.25 MB"
    l1d_assoc = "8"
    l1d_cacheline_size = "64"
    l1d_cache_nosets = "64"
    l2_assoc = "16"
    l2_cacheline_size = "64"
    l2_cache_nosets = "1024"
    l3_assoc = "11"
    l3_cacheline_size = "64"
    l3_cache_nosets = "45056"
    no_numa_nodes = "2"
    no_cores_per_node = "22"
    no_threads_per_node = "44"
    ...
    fig.add_trace(go.Indicator(
        mode = "number",
        value = 2,
        number = {"font": {"color": "black", "size": number_size}, "prefix": "Intel(R) Xeon(R) Gold 615", "suffix": " CPU @ 2.10GHz"},
    ...
    fig.add_trace(go.Indicator(
        mode = "number",
        value = 2,
        number = {"font": {"color": "black", "size": number_size}, "prefix": "sse sse2 ssse3 sse4_1 sse4_", "suffix": ""},
    ...
    fig.add_trace(go.Indicator(
        mode = "number",
        value = 2,
        number = {"font": {"color": "black", "size": number_size}, "prefix": "avx avx2 avx51", "suffix": ""},
        title = {"text": "Supported AVX Instructions", "font": {"color": "gray", "size": title_size}},
        domain = {'row': 7, 'column': 1}
    ))

    fig = grafana_layout_2(fig)
    fig.update_layout(grid = {'rows': 8, 'columns': 3, 'pattern': "independent"})
    dict_fig = json.loads(io.to_json(fig))
    empty_dash["panels"].append(two_templates_two(dict_fig["data"], dict_fig["layout"]))
