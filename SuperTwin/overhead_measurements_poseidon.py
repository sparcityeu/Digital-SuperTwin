...
def main(addr, config, name, run_name, alias):
    ...
    for item in mes:
        ...
        metric = item["name"]
        if(metric == "cpu_use"):
            proc_br += (2 * datapoints)
            total_datapoints += datapoints
        elif(metric == "mem_use"):
            proc_br += datapoints
        elif(metric.find("proc") != -1):
            proc_br += datapoints
        elif(metric.find("perfevent") != -1):
            perfevent_br += datapoints
        else:
            linux_br += datapoints
...
if __name__ == "__main__":
    ...
    main("10.92.55.4", " -c accurate_measurements/poseidon_10.conf :configured", "poseidon", "try0", "poseidon10")
    print("With 20 metrics")
    main("10.92.55.4", " -c accurate_measurements/poseidon_20.conf :configured", "poseidon", "try0", "poseidon20")
    print("With 30 metrics")
    main("10.92.55.4", " -c accurate_measurements/poseidon_30.conf :configured", "poseidon", "try0", "poseidon30")
    print("With 40 metrics")
    main("10.92.55.4", " -c accurate_measurements/poseidon_40.conf :configured", "poseidon", "try0", "poseidon40")
    print("With 50 metrics")
    main("10.92.55.4", " -c accurate_measurements/poseidon_50.conf :configured", "poseidon", "try0", "poseidon50")
    print("With monitor metrics")
    main("10.92.55.4", " -c accurate_measurements/pcp_poseidon_monitor :configured", "poseidon", "try0", "poseidonmonitor")
    print("#########################################################################################")
