...
if __name__ == "__main__":
    ...
    metrics = [" -c cstress/dolap_1.conf",
               " -c cstress/dolap_8.conf",
               " -c cstress/dolap_16.conf",
               " -c cstress/dolap_24.conf"]
    ...
    for interval in intervals:
        for metric in metrics:
            for bench in benchs:
                ...
                print("config:", config)
                times = one_run_sampled(my_superTwin, bench, config, "dolap[5_run")
