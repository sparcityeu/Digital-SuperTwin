...
if __name__ == "__main__":
    ...
    for size in sizes:
        for bench in benchs:
            ...
            config = "-t 0.03125 -c cstress_configs/dolap_" + str_mtr + ".conf :configured"
            one_run_sampled(my_superTwin, bench, config, "dolap_run", baseline, mtr, 32)
            print("##################" + bench + "##################")
            
            '''
            config = "-t 0.015625 -c cstress_configs/dolap_" + str_mtr + ".conf :configured"
            one_run_sampled(my_superTwin, bench, config, "dolap_run", baseline, mtr, 64)
            print("##################" + bench + "##################")

            config = "-t 0.0078125 -c cstress_configs/dolap_" + str_mtr + ".conf :configured"
            one_run_sampled(my_superTwin, bench, config, "dolap_run", baseline, mtr, 128)
            print("##################" + bench + "##################")
            
            config = "-t 0.00390625 -c cstress_configs/dolap_" + str_mtr + ".conf :configured"
            one_run_sampled(my_superTwin, bench, config, "dolap_run", baseline, mtr, 256)
            print("##################" + bench + "##################")
            '''
