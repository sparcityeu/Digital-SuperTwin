...
deren_24_1 = _deren_data.loc[(_deren_data["no_metric"] == 8) & (_deren_data["frequency"] == 8)]
dolap_24_1 = _dolap_data.loc[(_dolap_data["no_metric"] == 8) & (_dolap_data["frequency"] == 8)]
luna_24_1 = _luna_data.loc[(_luna_data["no_metric"] == 8) & (_luna_data["frequency"] == 8)]
poseidon_24_1 = _poseidon_data.loc[(_poseidon_data["no_metric"] == 24) & (_poseidon_data["frequency"] == 8)]
