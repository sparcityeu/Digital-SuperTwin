...
if __name__ == "__main__":
    ...
    metrics = [" -c cstress/poseidon_1.conf",
               " -c cstress/poseidon_8.conf",
               " -c cstress/poseidon_16.conf",
               " -c cstress/poseidon_24.conf"]
    ...
    for interval in intervals:
        for metric in metrics:
            for bench in benchs:
                ...
                print("config:", config)
                times = one_run_sampled(my_superTwin, bench, config, "poseidon_run")
