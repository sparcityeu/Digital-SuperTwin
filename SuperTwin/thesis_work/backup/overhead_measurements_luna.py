...
if __name__ == "__main__":
    ...
    main("10.36.52.109", " -c accurate_measurements/luna_10.conf :configured", "luna", "try0", "luna10")
    print("With 20 metrics")
    main("10.36.52.109", " -c accurate_measurements/luna_20.conf :configured", "luna", "try0", "luna20")
    print("With 30 metrics")
    main("10.36.52.109", " -c accurate_measurements/luna_30.conf :configured", "luna", "try0", "luna30")
    print("With 40 metrics")
    main("10.36.52.109", " -c accurate_measurements/luna_40.conf :configured", "luna", "try0", "luna40")
    print("With 50 metrics")
    main("10.36.52.109", " -c accurate_measurements/luna_50.conf :configured", "luna", "try0", "luna50")
    print("Monitor metrics")
    main("10.36.52.109", " -c accurate_measurements/pcp_luna_monitor.conf :configured", "luna", "try0", "lunamonitor")
    print("#########################################################################################")
