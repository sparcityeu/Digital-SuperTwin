...
def perform_triad(ssh, SuperTwin):
    ...
    stdin, stdout, stderr = ssh.exec_command("likwid-bench -t triad -w S0:100kB:1 -s 10")
...
def perform_sum(ssh, SuperTwin):
    ...
    stdin, stdout, stderr = ssh.exec_command("likwid-bench -t sum -w S0:100kB:1 -s 10")
    stdout = stdout.readlines()
...
def perform_stream(ssh, SuperTwin):
    ...
    stdin, stdout, stderr = ssh.exec_command("likwid-bench -t stream -w S0:100kB:1 -s 10")
    stdout = stdout.readlines()
...
def perform_peakflops(ssh, SuperTwin):
    ...
    stdin, stdout, stderr = ssh.exec_command("likwid-bench -t peakflops -w S0:100kB:1 -s 10")
    stdout = stdout.readlines()
...
def perform_ddot(ssh, SuperTwin):
    ...
    stdin, stdout, stderr = ssh.exec_command("likwid-bench -t ddot -w S0:100kB:1 -s 10")
    stdout = stdout.readlines()
...
def perform_daxpy(ssh, SuperTwin):
    ...
    stdin, stdout, stderr = ssh.exec_command("likwid-bench -t daxpy -w S0:100kB:1 -s 10")
    stdout = stdout.readlines()
