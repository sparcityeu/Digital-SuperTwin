...
def get_sum(metric):
    ...
    client.switch_database("deren_run")
...
def write_accuracy_to_file(db, bench, metric, no_metrics, frequency, accuracy):
    ...
    writer = open("deren_cstress_accuracy.csv", "a")
    writer.write(line)
    writer.close()
...
def write_overhead_to_file(db, bench, no_metrics, frequency, overhead):
    ...
    writer = open("deren_cstress_overhead.csv", "a")
    writer.write(line)
    writer.close()
    print("Wrote line - ", line)
#######
...
if __name__ == "__main__":
    ...
    for size in sizes:
        for bench in benchs:
            ...
            config = "-t 1 -c cstress_configs/deren_" + str_mtr + ".conf :configured"
            one_run_sampled(my_superTwin, bench, config, "deren_run", baseline, mtr, 1)
            print("##################" + bench + "##################")
            
            config = "-t 0.5 -c cstress_configs/deren_" + str_mtr + ".conf :configured"
            one_run_sampled(my_superTwin, bench, config, "deren_run", baseline, mtr, 2)
            print("##################" + bench + "##################")
            
            config = "-t 0.25 -c cstress_configs/deren_" + str_mtr + ".conf :configured"
            one_run_sampled(my_superTwin, bench, config, "deren_run", baseline, mtr, 4)
            print("##################" + bench + "##################")
            
            config = "-t 0.125 -c cstress_configs/deren_" + str_mtr + ".conf :configured"
            one_run_sampled(my_superTwin, bench, config, "deren_run", baseline, mtr, 8)
            print("##################" + bench + "##################")
            
            config = "-t 0.0625 -c cstress_configs/deren_" + str_mtr + ".conf :configured"
            one_run_sampled(my_superTwin, bench, config, "deren_run", baseline, mtr, 16)
            print("##################" + bench + "##################")
        
            config = "-t 0.03125 -c cstress_configs/deren_" + str_mtr + ".conf :configured"
            one_run_sampled(my_superTwin, bench, config, "deren_run", baseline, mtr, 32)
            print("##################" + bench + "##################")
            
            '''
            config = "-t 0.015625 -c cstress_configs/deren_" + str_mtr + ".conf :configured"
            one_run_sampled(my_superTwin, bench, config, "deren_run", baseline, mtr, 64)
            print("##################" + bench + "##################")
            
            config = "-t 0.0078125 -c cstress_configs/deren_" + str_mtr + ".conf :configured"
            one_run_sampled(my_superTwin, bench, config, "deren_run", baseline, mtr, 128)
            print("##################" + bench + "##################")
            
            config = "-t 0.00390625 -c cstress_configs/deren_" + str_mtr + ".conf :configured"
            one_run_sampled(my_superTwin, bench, config, "deren_run", baseline, mtr, 256)
            print("##################" + bench + "##################")
            '''
